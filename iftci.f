...
c************************************************************************************
c
c   1) Compilation (linux):  gfortran -m64 -O2 iftci_k.f -o iftci
c
...
c*********************************************
 ...
 1965 format(1x,'Axial ratio from prior     : ',f9.2,
  ...
  961 format(1x,'Chi-square for solution    : ',e9.2,
     -'  +- ',f8.2,' ')
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
   ...
   75 CONTINUE
      ...
      k=4
      fx=(k*alpha*m(i)/sigma(i)+ysum(i)-fsumi)/(k*alpha/sigma(i)+b(i,i))
        endif
